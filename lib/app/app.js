 ...
 */
app.main = fm.script([
  dm.link('scheme', act.dm.Type.JSON, SCHEME_FILE_NAME),
  dm.link('node.externs', act.dm.Type.DIRECTORY, NODE_EXTERNS_DIR),

  dm.retrieve('scheme'),
  dm.link('modules', dm.Type.OBJECT, 'scheme'),

  dm.assign('scheme', app.act.scheme.transform),

  dm.assign('cmd.name', app.act.cli.read),
  app.act.cmd.invoke
]);
